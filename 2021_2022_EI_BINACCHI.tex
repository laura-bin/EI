...
%    \url{https://sci-hub.se/https://www.jstor.org/stable/29775194#}
    ...
    \paragraph{}
    % et comme le traitement de signal sur architecture ARM avec la librairie \emph{Ne10} est un sujet de niche, peu de ressources permettent de combler ce manque.
