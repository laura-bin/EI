...
%    \url{https://sci-hub.se/https://www.jstor.org/stable/29775194#}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{./images/validation_mdct_fftw3_f32.pdf}
        \caption{}
        \label{fig:}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{./images/validation_mdct_ne10_f32.pdf}
        \caption{}
        \label{fig:}
    \end{figure}
...
% standard deviation: 1.36369e-07 ns
    ...
    En + des performances, précision pas top avec beaucoup de dépassements, pas réussi à les supprimer de manière simple mais pas grave pcq ce n'est qu'un algo intermédiaire (si on veut le garder comme ref il faudrait le faire fonctionner). -> graphique qui montre que les dépassements faussent les résultats


    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{./images/validation_mdct_i32_c.pdf}
        \caption{}
        \label{fig:}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\linewidth]{./images/validation_mdct_i32_neon.pdf}
        \caption{}
        \label{fig:}
    \end{figure}
