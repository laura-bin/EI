...
% standard deviation: 1.36369e-07 ns
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{ l | D{.}{.}{-1} | D{.}{.}{-1} }
            \multicolumn{1}{c|}{\textbf{MDCT testée}} & \multicolumn{1}{c|}{\textbf{Temps d'exécution}} &\multicolumn{1}{c}{\textbf{Écart type (ns)}} \\
            \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{\textbf{moyen (ns)}} & \multicolumn{1}{c}{}\\
            \hline
            \emph{MDCT Ne10 i32 Neon}   &  5796.35              & 0.02259 \times 10^{-6} \\
            \emph{MDCT Ne10 i32 C}      & 14939.7               & 0.93554 \times 10^{-6} \\
            \emph{MDCT Ne10 f32}        &  9020.1               & 0.02251 \times 10^{-6} \\
            \emph{MDCT FFTW3 f32}       &  7446.84              & 1.29403 \times 10^{-6} \\
            \emph{MDCT reference f32}   & 29212.6 \times 10^3   & 0.77552 \times 10^{-6} \\
        \end{tabular}
