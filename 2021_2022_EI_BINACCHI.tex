...
\begin{document}
    ...
    \paragraph{}
    Ces quelques explications permettent de comprendre l'intérêt de l'analyse fréquentielle d'un signal. L'analyse fréquentielle entre en jeu dans la compression des données pour déterminer une partie des informations qui peuvent être éliminées. Elle contribue ainsi à augmenter les capacités de traitement du système audio.
    ...
    \paragraph{}
    La MDCT a été développée il y a une trentaine d'années par ..
    % \begin{itemize}
