...
\begin{document}
    ...
    % dire ce qu'est une MDCT
    % parler du fixed point et des avantages attendus

    % but de la section validation : montrer une plus grande variété de tests que dans le reste du travail
    ...
    % L'impact de la window function : exemple avec un sinus : les composantes fréquentielles du sinus ressortent beaucoup mieux. mais aussi il n'y a pas de dépassement par rapport à du Q15 -> à voir si ça ne permettrait pas de passer tout en Q15
