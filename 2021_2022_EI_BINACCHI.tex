...
\begin{document}
    ...
    \paragraph{}
    Compilation Cmake + exemple de la création d'un exécutable avec paramètres
    ...
    double frequency, double phase_shift, int sampling_frequency)
{
    ...
    for (int i = 0; i < n_samples; ++i)
    {
        ...
        \section{Code de test des performances}
        \label{an:run_mdcts}
        \begin{lstlisting}
#include <iomanip>
#include <iostream>
...
int main(int argc, char **argv) {
    ...
    return 0;
        ...
        \section{CMake file générant les exécutables de test performance}
