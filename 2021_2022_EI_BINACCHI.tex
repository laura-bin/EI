...
\begin{document}
    ...
    % Travail qui s'incrit dans la continuité d'un travail théorique préalable
    ...
    \section{EVS Brodcast Equipment}
    \subsection{L'entreprise en quelques infos}
    \subsection{Les produits / le seveur XT}
...
%    \url{https://sci-hub.se/https://www.jstor.org/stable/29775194#}
    ...
    % Test de perforfmance : il faut qu'à la fin l'implementation fixed point soit au moins aussi rapide que floating point



    \section{Optmisations à l'architecture ARM}
    ...
    % Les opérations SIMD permettent de faire plusieurs opérations en uen fois où l'algo normal n'en fait qu'une à la fois. L'algo SIMD permet de faire plusieurs modificatiosn à la fois -> il faut ranger les données de manière à pouvoir l'appliquer facilement (fonction fenêtre -> tri des données ? )
    ...
    \subsection{Gain de performance}
    ...
    % L'impact de la window function : exemple avec un sinus : les composantes fréquencielles du sinus ressortent beaucoup mieux.
